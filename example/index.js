...
function () {
  ...
  _createClass(Ticker, [{
    ...
    value: function _tick() {
      ...
      var diff = now - this.timestamp + extra;
      var loop = Math.floor(diff / this.interval);
...
var _default = {
  ...
  workerify: function workerify(func) {
    ...
    (0, _inherits.default)(__Worker__, _eventemitter.default);
...
exports.default = _default;
},{"eventemitter3":"../node_modules/eventemitter3/index.js","inherits":"../node_modules/inherits/inherits_browser.js"}],"sound/browser.js":[function(require,module,exports) {
...
exports.default = _default;
},{"buffer":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js","eventemitter3":"../node_modules/eventemitter3/index.js"}],"sound/wechat.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Processor, [{
    ...
    value: function _onTickHandler() {
      ...
      if (this.hasAudio && this.hasVideo) {
        ...
        if (this.frames.length) {
          ...
          if (this.bufferingIndex == -1) {
            ...
            _diff = lastFrameTimestamp - this.currentTime;
          } else if (this.frames[this.bufferingIndex]) {
            var timestamp = this.frames[this.bufferingIndex].timestamp;
            _diff = lastFrameTimestamp - timestamp;
          }
        }

        if (!this.frames.length || !this.isEnded && _diff && _diff < this.minBufferingTime) {
        ...
        for (var i = 0; i < this.frames.length; i++) {
          ...
          var _diff3 = this.currentTime - _timestamp2;

          if (Math.abs(_diff3) <= 25) {
      ...
      if (this.hasVideo && this.frames.length) {
        var _lastIndex = this.frames.length - 1;

        var currentTime = this.currentTime;
        diff = this.frames[_lastIndex].timestamp - currentTime;
      }

      if (!this.isEnded && this.state != 'buffering' && this.hasVideo && !this.hasAudio && diff < this.bufferingTime) {
        this.state = 'buffering';
        this.emit('buffering');
        return;
      }

      if (this.hasVideo && this.state != 'preload' && this.state != 'buffering' && (this.frames.length < this.cacheSegmentCount || diff < this.averageDecodeCost * 1.3)) {
        this.state = 'preload';
        this.emit('preload');
      }
    }
    ...
    value: function _onCodecMsgHandler(msg) {
      ...
      switch (type) {
        ...
        case 'decode':
          {
            if (this.state == 'buffering' || this.hasVideo && this.state != 'playing' || !this.hasVideo && this.hasAudio && this.state != 'playing') {
              this.emit('playing');
            }

            this.state = 'playing';
            this.ticker.setFps(this.framerate);
            var consume = msg.data.consume;
...
exports.default = _default;
},{"buffer":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js","eventemitter3":"../node_modules/eventemitter3/index.js","../util/ticker":"util/ticker.js","../sound/sound":"sound/sound.js","../util/util":"util/util.js"}],"loader/stream.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_EventEmitter) {
  _inherits(ChunkLoader, _EventEmitter);
  ...
  function ChunkLoader(_ref) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ChunkLoader).call(this));
    _this.url = url;
  ...
  _createClass(ChunkLoader, [{
    ...
    value: function _request() {
      ...
      var _loop = function _loop(i) {
        promise = promise.then(function (buffer) {
          if (!isSuccess) {
            isSuccess = true;
            _this2.downloadSize += buffer.length;

            if (buffer.length < _this2.chunkSize) {
              _this2.done = true;
            }
          }
    ...
    value: function _fetch() {
      ...
      return new Promise(function (resolve, reject) {
        var endIndex = _this3.startIndex + _this3.chunkSize;
        _this3.xhr = new XMLHttpRequest();

        _this3.xhr.open('GET', _this3.url);

        _this3.xhr.responseType = 'arraybuffer';

        _this3.xhr.setRequestHeader('Range', "bytes=".concat(_this3.startIndex, "-").concat(endIndex));

        _this3.xhr.onerror = function (e) {
          reject({
            status: -1,
            statusText: 'unknown error',
            detail: e
        ...
        _this3.xhr.onload = function () {
          if (_this3.xhr.readyState == 4) {
            if (_this3.xhr.status >= 200 && _this3.xhr.status <= 299) {
              if (!_this3.emitted) {
                _this3.emitted = true;

                _this3.emit('loadSuccess');
              }

              _this3.startIndex = endIndex + 1;
              resolve(new Uint8Array(_this3.xhr.response));
            } else {
              reject({
                status: _this3.xhr.status,
                statusText: _this3.xhr.statusText,
                detail: String.fromCharCode.apply(null, new Uint8Array(_this3.xhr.response))
              });
            }
          }
        };
...
exports.default = _default;
},{"buffer":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js","eventemitter3":"../node_modules/eventemitter3/index.js"}],"loader/loader.js":[function(require,module,exports) {
"use strict";
...
function (_EventEmitter) {
  ...
  _createClass(WXInlinePlayer, [{
    ...
    value: function _initlize() {
      ...
      this.loader.on('loadError', function (error) {
        return _this2.emit('loadError', error);
      });
      this.loader.on('loadSuccess', function () {
        return _this2.emit('loadSuccess');
      });
