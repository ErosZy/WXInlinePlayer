...
exports.default = _default;
},{"./finally":"../node_modules/promise-polyfill/src/finally.js"}],"../../../Users/eroszhao/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
exports.default = _default;
},{"buffer":"../../../Users/eroszhao/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js","eventemitter3":"../node_modules/eventemitter3/index.js"}],"sound/wechat.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"promise-polyfill":"../node_modules/promise-polyfill/src/index.js","./browser":"sound/browser.js"}],"sound/sound.js":[function(require,module,exports) {
"use strict";
    ...
    value: function _onTickHandler() {
      ...
      if (this.hasAudio && this.hasVideo) {
        ...
        for (var i = 0; i < this.frames.length; i++) {
          ...
          if (_diff2 > 0 && _diff2 <= 25 || _diff2 < 0 && _diff2 >= -100) {
        ...
        case 'video':
          {
            ...
            this.frames.push({
              data: _buffer3.Buffer.from(new Uint8Array(buffer)),
        ...
        case 'audio':
          {
            ...
            this.audios.push(_buffer3.Buffer.from(new Uint8Array(_buffer)));
            break;
          }
        ...
        case 'decode':
          {
            ...
            if (this.hasAudio) {
              ...
              var _buffer2 = _buffer3.Buffer.concat(this.audios);

              this.sound.decode(_buffer2);
              this.audios = [];
            }
...
exports.default = _default;
},{"buffer":"../../../Users/eroszhao/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js","eventemitter3":"../node_modules/eventemitter3/index.js","../util/ticker":"util/ticker.js","../sound/sound":"sound/sound.js","../util/util":"util/util.js"}],"loader/stream.js":[function(require,module,exports) {
...
function () {
  function StreamLoader(_ref) {
    ...
    this.data = new _buffer.Buffer(0);
    this.abortController = null;

    try {
      this.abortController = new AbortController();
    } catch (e) {// not support, ignore it.
    }
  }
  ...
  _createClass(StreamLoader, [{
    ...
    key: "_getChunk",
    value: function _getChunk() {
      var _this2 = this;

      return new _promisePolyfill.default(function (resolve) {
        var buffer = _this2.data.slice(0, _this2.chunkSize);

        _this2.data = _this2.data.slice(_this2.chunkSize);
        resolve(buffer);
      });
    }
  }, {
    ...
    value: function _request() {
      ...
      if (this.reader) {
        return this.reader.read().then(function (result) {
          ...
          value = _buffer.Buffer.from(value ? value : new Uint8Array(0));
          _this3.data = _buffer.Buffer.concat([_this3.data, value]);
...
var _default = StreamLoader;
exports.default = _default;
},{"promise-polyfill":"../node_modules/promise-polyfill/src/index.js","buffer":"../../../Users/eroszhao/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"loader/chunk.js":[function(require,module,exports) {
...
function () {
  ...
  _createClass(ChunkLoader, [{
    ...
    value: function read() {
      ...
      return _promisePolyfill.default.resolve(new _buffer.Buffer(0));
    }
  }, {
    key: "cancel",
    value: function cancel() {
...
exports.default = _default;
},{"promise-polyfill":"../node_modules/promise-polyfill/src/index.js","buffer":"../../../Users/eroszhao/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"loader/loader.js":[function(require,module,exports) {
"use strict";
...
function Loader(_ref) {
  var _ref$type = _ref.type,
      ...
      opt = _ref.opt;
  return type == 'chunk' ? new _chunk.default(opt) : new _stream.default(opt);
}

var _default = Loader;
exports.default = _default;
},{"./stream":"loader/stream.js","./chunk":"loader/chunk.js"}],"drawer/drawer.js":[function(require,module,exports) {
"use strict";
...
function (_EventEmitter) {
  ...
  _createClass(WXInlinePlayer, [{
    ...
    value: function init(_ref3) {
      ...
      WXInlinePlayer.initPromise = new _promisePolyfill.default(function (resolve, reject) {
    ...
    key: "isSupport",
    value: function isSupport() {
      return !!(window.URL && window.URL.createObjectURL && window.Blob && window.Worker && !!new Audio().canPlayType('audio/aac;').replace(/^no$/, '') && (window.AudioContext || window.webkitAudioContext) && _drawer.default.isSupport());
    }
  }, {
    key: "ready",
    value: function ready() {
      if (!WXInlinePlayer.isSupport()) {
        return _promisePolyfill.default.resolve(false);
      }

      if (WXInlinePlayer.isInited) {
        return _promisePolyfill.default.resolve(true);
      }
...
exports.default = _default;
},{"eventemitter3":"../node_modules/eventemitter3/index.js","promise-polyfill":"../node_modules/promise-polyfill/src/index.js","./processor/processor":"processor/processor.js","./loader/loader":"loader/loader.js","./drawer/drawer":"drawer/drawer.js","./util/util":"util/util.js"}],"../../../Users/eroszhao/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
